...
export const isPrivateClient = (clientName?: string | null): boolean => {
  ...
  if (/시청|도청|군청|구청|읍사무소|면사무소|동사무소|주민센터|행정복지센터|환경부|국토교통부|산업통상자원부|보건복지부|농림축산식품부|해양수산부|문화체육관광부|교육부|과학기술정보통신부|외교부|통일부|법무부|국방부|행정안전부|기획재정부|여성가족부|중소벤처기업부|국세청|관세청|특허청|병무청|조달청|통계청|검찰청|감사원|국회|법원|선거관리위원회|국가정보원|경찰청|소방청|기상청|문화재청|산림청|농촌진흥청/.test(name)) return false;
